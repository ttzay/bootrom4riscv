...
#define UART_LSR_TX_EMPTY 0x20        // Transmit buffer empty

static inline void uart_putc(char c) {
    while (!(*(volatile char *)UART_LSR & UART_LSR_TX_EMPTY));
    *(volatile char *)UART_THR = c;
}
...
void bootloader() {
  ...
  */
  ...
  uart_puts("Generated random seed...\n");
  ...
  uart_puts("SM key pair generated...\n");
  ...
  uart_puts("SM signed successfully!\n");
  // Clean up
  // Erase SK_D
